...
| **Technical quality / completeness** | Full operation surface: deploy / verify / createOrder / completeOrder / disputeOrder / refundOrder / withdraw / getOrder + 6 events. All have command templates, parameter tables, output parsing rules, error handling. Forge test suite covers happy-path + adversarial cases. |
